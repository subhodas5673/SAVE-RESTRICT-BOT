...
FREE_LIMIT_DAILY = 10
UPI_ID = os.environ.get("UPI_ID", "Q047210667@ybl")
QR_CODE = os.environ.get("QR_CODE", "https://raw.githubusercontent.com/subhodas5673/SAVE-RESTRICT-BOT/refs/heads/master/assets/image/qr.jpg")
REACTIONS = [
    "👍", "❤️", "🔥", "🥰", "👏", "😁", "🤔", "🤯", "😱", "🤬",
    "😢", "🎉", "🤩", "🤮", "💩", "🙏", "👌", "🕊", "🤡", "🥱",
    "🥴", "😍", "🐳", "❤️‍🔥", "🌚", "🌭", "💯", "🤣", "⚡", "🍌",
...
"""
    CAPTION = """<b><a href="https://t.me/tgH2R"></a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/tgH2R">tgH2R 😎</a></b>"""
...
async def send_plan(client: Client, message: Message):
    buttons = [
        [InlineKeyboardButton("📸 Send Payment Proof", url="https://t.me/tgH2R")],
